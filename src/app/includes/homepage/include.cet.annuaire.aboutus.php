        ...
        <div class="d-flex col-12 col-xl-4 order-3 order-xl-2 align-items-center justify-content-center">
            <div class=" w-100 address-wrapper d-flex justify-content-center flex-column">
                ...
                <address class="text-center pt-2">
                    ...
                    <br>
                    <a class="font-italic pt-2" href="www.castillonnaisentransition.org">www.castillonnaisentransition.org</a>
                    <br>
                    <br>
                    <a  class="" href="mailto:contact@decidelabiolocale.org">contact@decidelabiolocale.org</a><br>
                    téléphone : 06.81.28.88.03<br>
                    facebook : @castillonnaisentransition
                </address>
            </div>
        </div>
