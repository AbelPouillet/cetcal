<header>
    <!--- DEBUT HEADER --->
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 herosection-wrapper d-lg-flex d-xl-flex flex-column-reverse flex-lg-row-reverse flex-xl-row-reverse">
