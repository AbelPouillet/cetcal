...
var cetAnnuaireIcon_inscrit = L.icon({
    ...
    iconSize: [50, 50],
    popupAnchor: [0, -20],
    type: 'Producteur partenaire www.decidelabiolocale.org'
});
...
var associationsIcon = L.icon({
    ...
    iconSize: [50, 50],
    popupAnchor: [0, -20],
    type: 'Associations liée à la BIO Locale (distribution possible)'
});
