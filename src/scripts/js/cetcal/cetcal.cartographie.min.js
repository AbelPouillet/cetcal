...
$(document).ready(function () {
  ...
  $('#rav-homepage-envoyer').on('mousedown', function () {
    ...
    json_rav.rayon = $("#homepage-rav-rayon").find(":selected").val();
...
var cetAnnuaireIcon_algues = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/algues.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Algues'
})
icons_array.push({ icon: cetAnnuaireIcon_algues, desc: 'Producteur d\'algues' });

var cetAnnuaireIcon_apiculteur = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/apiculteur.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Apiculteur'
})
icons_array.push({ icon: cetAnnuaireIcon_algues, desc: 'Apiculteur' });

var cetAnnuaireIcon_boulanger_patissier = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/boulanger_patissier.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Boulanger patissier'
})
icons_array.push({ icon: cetAnnuaireIcon_boulanger_patissier, desc: 'Boulanger patissier' });

var cetAnnuaireIcon_brasseur = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/apiculteur.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Brasseur'
})
icons_array.push({ icon: cetAnnuaireIcon_brasseur, desc: 'Brasseur' });

var cetAnnuaireIcon_champignons = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/champignons.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Champignons'
})
icons_array.push({ icon: cetAnnuaireIcon_champignons, desc: 'Champignons' });

var cetAnnuaireIcon_conserves_confitures = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/conserves_confitures.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Conserves confitures'
})
icons_array.push({ icon: cetAnnuaireIcon_conserves_confitures, desc: 'Conserves confitures' });

var cetAnnuaireIcon_fromages = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/fromages.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Fromages'
})
icons_array.push({ icon: cetAnnuaireIcon_fromages, desc: 'Fromages' });


var cetAnnuaireIcon_fruits = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/fruits.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Fruits'
})
icons_array.push({ icon: cetAnnuaireIcon_fruits, desc: 'Fruits' });


var cetAnnuaireIcon_glaces_sorbets = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/glaces_sorbets.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Glaces Sorbets'
})
icons_array.push({ icon: cetAnnuaireIcon_glaces_sorbets, desc: 'Glaces Sorbets' });

var cetAnnuaireIcon_cereales = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/grandescultures_cereales.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Céréales'
})
icons_array.push({ icon: cetAnnuaireIcon_cereales, desc: 'Céréales' });

var cetAnnuaireIcon_horticulteur = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/horticulteur.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Horticulteur'
})
icons_array.push({ icon: cetAnnuaireIcon_horticulteur, desc: 'Horticulteur' });

var cetAnnuaireIcon_laitier = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/laitier.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Laitier'
})
icons_array.push({ icon: cetAnnuaireIcon_laitier, desc: 'Laitier' });

var cetAnnuaireIcon_legumes = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/legumes.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Legumes'
})
icons_array.push({ icon: cetAnnuaireIcon_legumes, desc: 'Legumes' });

var cetAnnuaireIcon_oeufs = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/oeufs.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Oeufs'
})
icons_array.push({ icon: cetAnnuaireIcon_oeufs, desc: 'Oeufs' });

var cetAnnuaireIcon_pecheur_coquillages = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/pecheur_coquillages.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Pécheur coquillages'
})
icons_array.push({ icon: cetAnnuaireIcon_pecheur_coquillages, desc: 'Pécheur coquillages' });

var cetAnnuaireIcon_plantes = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/plantes.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Plantes'
})
icons_array.push({ icon: cetAnnuaireIcon_plantes, desc: 'Plantes' });

var cetAnnuaireIcon_semencier_graines = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/semencier_graines.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Semencier graines'
})
icons_array.push({ icon: cetAnnuaireIcon_semencier_graines, desc: 'Semencier graines' });

var cetAnnuaireIcon_viande = L.icon({
  iconUrl: 'res/content/pictos_site_CAL/viande.gif',
  iconSize: [50, 50],
  popupAnchor: [0, -20],
  type: 'Viande'
})
icons_array.push({ icon: cetAnnuaireIcon_viande, desc: 'Viande' });
...
$('producteur').each(function (i) {
  ...
  //Assignation nouvelles icones TODO: (Vérifier la syntaxe des categorie)
  switch (categorie) {
    case 'Algues':
      icon_carto = cetAnnuaireIcon_algues
      break;
    case 'Apiculteur':
      icon_carto = cetAnnuaireIcon_apiculteur
      break;
    case 'Boulanger patissier':
      icon_carto = cetAnnuaireIcon_boulanger_patissier
      break;
    case 'Brasseur':
      icon_carto = cetAnnuaireIcon_brasseur
      break;
    case 'Champignons':
      icon_carto = cetAnnuaireIcon_champignons
      break;
    case 'Conserves confitures':
      icon_carto = cetAnnuaireIcon_conserves_confitures
      break;
    case 'Fromages':
      icon_carto = cetAnnuaireIcon_fromages
      break;
    case 'Fruits':
      icon_carto = cetAnnuaireIcon_fruits
      break;
    case 'Glaces Sorbets':
      icon_carto = cetAnnuaireIcon_glaces_sorbets
      break;
    case 'Céréales':
      icon_carto = cetAnnuaireIcon_cereales
      break;
    case 'Horticulteur':
      icon_carto = cetAnnuaireIcon_horticulteur
      break;
    case 'Laitier':
      icon_carto = cetAnnuaireIcon_laitier
      break;
    case 'Legumes':
      icon_carto = cetAnnuaireIcon_legumes
      break;
    case 'Oeufs':
      icon_carto = cetAnnuaireIcon_oeufs
      break;
    case 'Pécheur coquillages':
      icon_carto = cetAnnuaireIcon_pecheur_coquillages
      break;
    case 'Plantes':
      icon_carto = cetAnnuaireIcon_plantes
      break;
    case 'Semencier graines':
      icon_carto = cetAnnuaireIcon_semencier_graines
      break;
    case 'Viande':
      icon_carto = cetAnnuaireIcon_viande
      break;
    case 'viticulteur':
      icon_carto = cetAnnuaireIcon_viticulteur
      break;
    default:
      icon_carto = cetAnnuaireIcon
  }
