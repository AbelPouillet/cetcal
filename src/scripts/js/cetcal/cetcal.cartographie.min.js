...
$(document).ready(function() {
  ...
  $('#rav-homepage-envoyer').on('mousedown', function() {
    var commune_hp = $('#cet-annuaire-recherche-communes-homepage-value').val();
    var rayon_hp = null;
    $('.rav-hp-perim').each(function() {
      if ($(this).is(':checked')) rayon_hp = $(this).val();
    });

    // TODO : call ajax comme pour la RAV.
    console.log('commune_hp:' + commune_hp + ' rayon_hp:' + rayon_hp);
  });
});
