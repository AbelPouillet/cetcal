...
$('entite').each(function(i) {
    ...
    var popupOptions = {};
    var popup = L.popup(popupOptions, marker);
    popup.setContent('<span class="cet-ann-crt-popuptext-marches">' + denomination 
      + (logo_entite.length > 0 ? '<img class="mini-fiche-logo-element" src="' + logo_entite + '"/>' : '')
      + '</span><br>' + adresse
      + '<br><br><a href="./?statut=asso.vente&anr=true&type=' + type + '&q=' + denomination + '" target="_blank">Voir plus d\'informations</a>');
    marker.bindPopup(popup);
