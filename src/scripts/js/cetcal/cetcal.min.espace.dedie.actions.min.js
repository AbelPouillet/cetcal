$(document).ready(function() {
  ...
  $('#espace-prd-modifier-geoloc').on('mousedown', function() {
    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        $('#data-geoloc-espace-producteur-container').toggle('slow');
      },
    ...
    if (notEqualMdpMdpConf($('#qstprod-espace-prd-nouveau-mdp').val(), 
      ...
      $.ajax({
        ...
        success: function(json) { 
          console.log(json);
          var data = JSON.parse(json);
          if (data.etat === 'true') $('#data-mdp-espace-producteur-container').hide('slow');
          $('#espace-prd-modifier-mdp-outcome').html(data.msg);
          if (data.etat === 'true') $('#espace-prd-modifier-mdp-outcome').css('color', 'green');
          else if (data.etat === 'false') $('#espace-prd-modifier-mdp-outcome').css('color', 'red');
  ...
  $('#espace-prd-modifier-media').on('mousedown', function() {
    $('#data-media-espace-producteur-container').toggle('slow');
  });
...
function appendAllMedia(images) {
  ...
  clearAllFiles(2000);
  gestionZones(logo_ajoute, compte_img_ferme, 720);
}
...
function gestionZones(logoAjoute, compteImgFerme, t) {
