...
$(document).ready(function() {
  ...
  $(window).width() <= 700 ? $('div#w-100-infeq-700-div-id').removeClass('col-6').addClass('col-12') : 
    $('div#w-100-infeq-700-div-id').removeClass('col-12').addClass('col-6');
  $(window).resize(function() {
	...
	$(window).width() > 700 ? $('#valider-recherche-commune-cartographie').html('Valider') : 
